...
setenv('FSLDIR', '/isis/home/saida2/fsl'); 
system(['flirt -interp trilinear -in ' tmp_dir '/Label' num2str(i) '.nii.gz -ref ' AtlasTemplate ' -applyxfm -init /isis/home/saida2/projects/Conorpipeline/Liston-Laboratory-MultiEchofMRI-Pipeline/MultiEchofMRI-Pipeline/res0urces/ident.mat -out ' tmp_dir '/Label' num2str(i) '_Interp.nii.gz']);
