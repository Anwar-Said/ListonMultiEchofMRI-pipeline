...
MEDIR="/isis/home/saida2/projects/Conorpipeline/Liston-Laboratory-MultiEchofMRI-Pipeline/MultiEchofMRI-Pipeline"
...
MEPCA=kundu # set the pca decomposition method (see "tedana -h" for more information) tedana: error: argument --tedpca: invalid choice: 'kundu' (choose from 'mdl', 'kic', 'aic')
# MEPCA=mdl # set the pca decomposition method (see "tedana -h" for more information)
MaxIterations=500 
MaxRestarts=5

# set variable value that sets up environment
EnvironmentScript="/isis/home/saida2/projects/Conorpipeline/HCPpipelines/Examples/Scripts/SetUpHCPPipeline.sh" # Pipeline environment script
...
"$MEPCA" "$MaxIterations" "$MaxRestarts" "$StartSession" "$MEDIR"
